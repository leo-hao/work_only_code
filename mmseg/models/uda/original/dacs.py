...
# PyTorch Image Models (timm)是一个图像模型（models）、
# 层（layers）、实用程序（utilities）、优化器（optimizers）、
# 调度器（schedulers）、数据加载/增强（data-loaders / augmentations）
# 和参考训练/验证脚本（reference training / validation scripts）的集合，
